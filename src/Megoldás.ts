...
export default class Megoldás {
    ...
    public nyertesTipp(forduló: number): null | number {
        const stat: number[] = new Array(100).fill(0); // 100 elemű vektor 0-al feltöltve
    ...
    public allomanyIr(állományNév: string, játékosNév: string, forduló: number, tipp: number): void {
        const ki: string[] = [];
